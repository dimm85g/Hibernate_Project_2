...
public class Main {
    ...
    public Main(){
        ...
        properties.put(Environment.PASS, "756429QQqq");
    ...
    private Customer createCustomer(){
            try (Session session = sessionFactory.getCurrentSession()){
                ...
                City city = cityDAO.getByName("Kolpino");

                Address address = new Address();
                address.setAddress(" Street ind, 9");
                address.setPhone("987652318");
                address.setCity(city);
                address.setDistrict("Center");
                addressDAO.save(address);

                Customer customer = new Customer();
                customer.setIsActive(true);
                customer.setEmail("knfnef@gmail.com");
                customer.setAddress(address);
                customer.setStore(store);
                customer.setFirstName("Dima");
                customer.setLastName("Parinov");
